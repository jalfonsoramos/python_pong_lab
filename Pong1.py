...
while True:
    ...
    if ball.ycor() > 290:
        ...
        # Linux
        #os.system("afplay ping_pong_8bit_plop.wav&")
        # Windows
    ...
    if ball.xcor() > 390:
        ...
        pen.write("Player A: {}   Player B: {}".format(score_a, score_b), align="center",
                  font=("Courier", 24, "normal"))
        # Mac
        #os.system("aplay ping_pong_8bit_peeeeeep.wav&")
        # Linux
        #os.system("afplay ping_pong_8bit_peeeeeep.wav&")
        # Windows
    ...
    # Paddlre and ball collisions
    if (ball.xcor() > 340 and ball.xcor() < 350) and (ball.ycor() < paddle_b.ycor() + 40 and ball.ycor() > paddle_b.ycor()-40):
        ball.setx(340)
        ball.dx *= -1
        # Mac
        #os.system("aplay ping_pong_8bit_beeep.wav&")
        # Linux
        #os.system("afplay ping_pong_8bit_beeep.wav&")
        # Windows
